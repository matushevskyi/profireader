...
class User(Base, UserMixin, PRBase):
    ...
    def get_client_side_dict(self,
                             fields='id|profireader_name|profireader_avatar_url|profireader_small_avatar_url|profireader_email|profireader_first_name|profireader_last_name|birth_tm|profireader_link|profireader_phone|location|profireader_gender|lang|about_me|country_id|tos|profireader_phone',
                             more_fields=None):
