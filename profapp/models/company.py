...
class UserCompany(Base, PRBase):
    ...
    ACTION_FOR_STATUSES_MEMBERSHIP = {
        ...
        MemberCompanyPortal.STATUSES['APPLICANT']: {MemberCompanyPortal.ACTIONS['WITHDRAW']: RIGHT_AT_COMPANY.COMPANY_REQUIRE_MEMBEREE_AT_PORTALS},
        MemberCompanyPortal.STATUSES['SUSPENDED']: {MemberCompanyPortal.ACTIONS['UNSUBSCRIBE']: RIGHT_AT_COMPANY.COMPANY_REQUIRE_MEMBEREE_AT_PORTALS},
        ...
        MemberCompanyPortal.STATUSES['REJECTED']: {MemberCompanyPortal.ACTIONS['WITHDRAW']: RIGHT_AT_COMPANY.COMPANY_REQUIRE_MEMBEREE_AT_PORTALS},
    ...
    ACTION_FOR_STATUSES_MEMBER = {
        ...
        MemberCompanyPortal.STATUSES['APPLICANT']: {MemberCompanyPortal.ACTIONS['REJECT']: RIGHT_AT_COMPANY.PORTAL_MANAGE_MEMBERS_COMPANIES,
                                MemberCompanyPortal.ACTIONS['ENLIST']: RIGHT_AT_COMPANY.PORTAL_MANAGE_MEMBERS_COMPANIES},
        MemberCompanyPortal.STATUSES['SUSPENDED']: {MemberCompanyPortal.ACTIONS['REJECT']:RIGHT_AT_COMPANY.PORTAL_MANAGE_MEMBERS_COMPANIES,
                                MemberCompanyPortal.ACTIONS['RESTORE']: RIGHT_AT_COMPANY.PORTAL_MANAGE_MEMBERS_COMPANIES},
        MemberCompanyPortal.STATUSES['FROZEN']: {},
        MemberCompanyPortal.STATUSES['REJECTED']: {MemberCompanyPortal.ACTIONS['RESTORE']: RIGHT_AT_COMPANY.PORTAL_MANAGE_MEMBERS_COMPANIES},
        MemberCompanyPortal.STATUSES['DELETED']: {}
    }
