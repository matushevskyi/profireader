...
$templateCache.put("src/templates/navbar.html","<nav class=\"navbar navbar-inverse\">\n    <div class=\"container-fluid\">\n        <div class=\"navbar-header\">\n            <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\"\n                    aria-expanded=\"false\" aria-controls=\"navbar\">\n                <span class=\"sr-only\">Toggle</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n            </button>\n        </div>\n        <div id=\"navbar\" class=\"navbar-collapse collapse\">\n            <div class=\"navbar-form navbar-right\">\n                <span class=\"progressbar\" ng-show=\"f.progress > 0 && hide === true\" ng-click=\"showModal()\"\n                      data-toggle=\"modal\" data-target=\"#uploadfile\"><div\n                        ng-bind=\"\'Uploading - \'+f.progress + \'%\'\"></div></span> <input type=\"text\"\n                                                                                       class=\"form-control input-sm\"\n                                                                                       placeholder=\"{{ _(\'search\') }}...\"\n                                                                                       ng-enter=\"$parent.search(query)\"\n                                                                                       ng-model=\"$parent.query\">\n                <button class=\"btn btn-default btn-sm\" data-toggle=\"modal\" data-target=\"#newfolder\" ng-click=\"touch()\"\n                        ang-disabled=\'can_upload !== true\'>\n                    <i class=\"glyphicon glyphicon-plus\"></i> {{ _(\"create_folder\") }}\n                </button>\n                <button title=\"{{ _(\'upload_file\') }}\" class=\"btn btn-default btn-sm\"\n                        data-toggle=\"modal\" data-target=\"#uploadfile\" ang-disabled=\'!root_selected.can_upload\'>\n                    <i class=\"glyphicon glyphicon-upload\"></i> {{ _(\"upload_file\") }}\n                </button>\n                <div class=\"dropdown\">\n                    <button class=\"btn btn-default btn-sm dropdown-toggle w20em nowrap tal pr2em\" type=\"button\"\n                            id=\"dropDownMenuRoots\" data-toggle=\"dropdown\" aria-expanded=\"true\">\n                        <img class=\"img-icon-in-text-3-1_5\"\n                                pr-image-url-watch=\"root_selected.icon_url\"/>{{ root_selected.icon }} {{ root_selected.name }}\n                        <span class=\"caret\"></span>\n                    </button>\n                    <ul class=\"dropdown-menu\" aria-labelledby=\"dropDownMenuRoots\">\n                        <li ng-class=\"{\'active\': root_selected.id === rootdir.id}\" ng-repeat=\"rootdir in rootdirs\" role=\"presentation\"><a role=\"menuitem\" tabindex=\"-1\" href=\"\"\n                                                                                   ng-click=\"changeRoot(rootdir)\"><img\n                                class=\"img-icon-in-text-3-1_5\"\n                                pr-image-url=\"{{ rootdir.icon_url }}\"/>{{ rootdir.icon }}&nbsp;&nbsp;{{ rootdir.name }}\n                        </a>\n                        </li>\n                    </ul>\n                </div>\n\n                <button class=\"btn btn-default btn-sm\" ng-click=\"$parent.setTemplate(\'main-icons.html\')\"\n                        ng-show=\"$parent.viewTemplate !== \'main-icons.html\'\" title=\"{{ _(\'icons\') }}\">\n                    <i class=\"glyphicon glyphicon-th-large\"></i>\n                </button>\n                <button class=\"btn btn-default btn-sm\" ng-click=\"$parent.setTemplate(\'main-table.html\')\"\n                        ng-show=\"$parent.viewTemplate !== \'main-table.html\'\" title=\"{{ _(\'list\') }}\">\n                    <i class=\"glyphicon glyphicon-th-list\"></i>\n                </button>\n\n            </div>\n        </div>\n    </div>\n</nav>");
